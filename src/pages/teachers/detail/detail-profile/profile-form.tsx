...
type ProfileFormProps = {
  ...
  facultiesOptions?: { value: string; label: string }[];
          ...
          <TabsContent value="main" className="p-6 mt-0 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-5">
              ...
              <div className="col-span-full space-y-1.5">
                <Label
                  htmlFor="fullName"
                  className="text-[12px] font-bold dark:text-zinc-400 ml-1"
                >
                  F.I.SH
                </Label>
                <Input
              ...
              <div className="space-y-1.5">
                <Label className="text-[12px] font-bold dark:text-zinc-400 ml-1">
                  Lavozimi
                </Label>
                <Controller
                  name="position"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <Textarea
                  id="bio"
                  maxLength={250}
                  className="min-h-[140px] rounded-lg border-slate-200 dark:border-zinc-800 dark:bg-zinc-900/30 resize-none p-4 text-sm"
                  {...register("bio")}
                />
              </div>
