...
export default function TeacherProfile() {
	...
	const handleProfileSubmit = (formData: ProfileFormData) => {
		...
		console.log(`%c=== API CALL DETAILS ===`, "background: #ff0000; color: white;");
		console.log(`%cEndpoint: /teacher/update-profile`, "background: #0000ff; color: white;");
		console.log(`%cMethod: PUT`, "background: #0000ff; color: white;");
		console.log(`%cPayload:`, "background: #0000ff; color: white;", payload);
		console.log(`%c========================`, "background: #ff0000; color: white;");

		alert("About to call updateProfile with payload: " + JSON.stringify(payload, null, 2));
	...
	const profileValues: ProfileFormData | null = useMemo(() => {
		...
		return {
			...
			faculty: facultiesOptions.find((f) => f.label === teacher.departmentName)?.value ?? "",
